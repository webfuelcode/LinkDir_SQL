...
## PHP Version
Project works on PHP 7.2.5 to 7.4
Using a higher PHP version, like 8.0 or above, will cause errors and break your application. This is the case for many of you who are struggling while deploying on the server. Try setting the PHP version to 7.
